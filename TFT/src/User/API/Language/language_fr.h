...
#define _LANGUAGE_FR_H_
    ...
    #define STRING_FILES_FULLNAME_VIEW    "Afficher l'extension des fichiers"
    #define STRING_FAN_SPEED_PERCENTAGE   "Vitesse des ventilateurs en %"
    #define STRING_PERSISTENT_INFO        "Températures toujours affichées"
    #define STRING_TERMINAL_ACK           "Afficher ACK sur le Terminal"
    #define STRING_SERIAL_ALWAYS_ON       "Port série toujours actif"
    #define STRING_MARLIN_FULLSCREEN      "Mode Marlin en plein écran"
    ...
    #define STRING_AUTO_LOAD_LEVELING     "Auto-Sauvegarde du nivellement"
    #define STRING_PROBING_Z_OFFSET       "Palpeur pour le Z Offset"
    #define STRING_Z_STEPPERS_ALIGNMENT   "Auto-Alignement des moteurs Z"
    ...
    #define STRING_TOAST_SOUND            "Son des notifications"
    #define STRING_ALERT_SOUND            "Son des popups et alertes"
    #define STRING_HEATER_SOUND           "Son des notifications de chauffe"
    #define STRING_LCD_BRIGHTNESS         "Luminosité"
    #define STRING_LCD_IDLE_BRIGHTNESS    "Diminution de la luminosité"
    #define STRING_LCD_IDLE_TIME          "Durée avant la diminution"
    #define STRING_LCD_LOCK_ON_IDLE       "Bloquer les touches en mode veille"
    #define STRING_KNOB_LED_COLOR         "Couleur de la LED du bouton rotatif"
    ...
    #define STRING_FILAMENT_SETTING       "Diamètre du filament"
    ...
    #define STRING_FWRETRACT              "Rétraction du firmware"
    #define STRING_FWRECOVER              "Récupération du firmware"
    #define STRING_RETRACT_AUTO           "Rétraction du firmware automatique"
    ...
    #define STRING_CURRENT_SETTING        "Courant des drivers (mA)"
    #define STRING_HYBRID_THRESHOLD       "Seuil hybride des drivers"
    #define STRING_BUMP_SENSITIVITY       "Sensibilité aux chocs des drivers"
    #define STRING_MBL_OFFSET             "Décalage MBL"

    // Machine Parameter Settings - Param Attributes (ordered by gcode)
    #define STRING_PRINT_ACCELERATION     "Lors de l'impression"
    #define STRING_RETRACT_ACCELERATION   "Lors des rétractions"
    ...
    #define STRING_SETTINGS_SAVE          "Sauvegarder les paramètres"
    #define STRING_SETTINGS_RESTORE       "Restaurer les paramètres"
    #define STRING_SETTINGS_RESET         "Remise à zéro des paramètres"
    ...
    #define STRING_Y                      "Y"
    #define STRING_Z                      "Z"
    #define STRING_ADJUST_TITLE           "Calibration de l'écran tactile"
