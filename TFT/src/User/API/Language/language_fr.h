...
#define _LANGUAGE_FR_H_
    ...
    #define STRING_FAN_SPEED_PERCENT      "Vitesse des ventilateurs en %"
    ...
    #define STRING_EMULATE_M600           "Emuler la fonction M600"
    ...
    #define STRING_LCD_IDLE_DELAY         "Durée avant la diminution"
    #define STRING_BLOCK_TOUCH_ON_IDLE    "Bloquer les touches en mode veille"
