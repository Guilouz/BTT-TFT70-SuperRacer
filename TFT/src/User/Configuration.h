 ...
 */
#define MAX_TEMP {275, 275, 275, 275, 275, 275, 100, 60}  // Default: {275, 275, 275, 275, 275, 275, 150, 60}
 ...
 *   Value range: [min: 10, max: 12000]
 */
#define SPEED_Z_SLOW   1000   // Default: 500
#define SPEED_Z_NORMAL 3000  // Default: 1000
#define SPEED_Z_FAST   5000  // Default: 2000
 ...
 *   Value range: [min: 10, max: 12000]
 */
#define LEVELING_EDGE_DISTANCE    5  // (mm) Inset distance from bed's edge for calculating leveling point location (Default: 20)
...
#define PREHEAT_HOTEND {215,   230,    240,   210,    220,   250}      // Default: {200,   240,    230,   170,    220,   250}
#define PREHEAT_BED    { 65,    70,     90,    65,     60,    90}      // Default: { 60,    70,     90,    50,     50,    90}
