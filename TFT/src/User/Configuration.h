...
#define MARLIN_FNCOLOR 3  // Marlin Mode font color (Default: 0)
 ...
 */
#define MARLIN_BANNER_TEXT "SUPER RACER"  // Default: "Marlin Mode"
...
#define PREHEAT_HOTEND {220,   230,    240,   210,    220,   250}
#define PREHEAT_BED    { 60,    70,     90,    60,     60,    90}

// Heat
#define HEAT_MAX_TEMP   {275,       275,       275,       275,       275,       275,       100,    60}
...
#define SPEED_Z_SLOW   1000
#define SPEED_Z_NORMAL 3000
#define SPEED_Z_FAST   5000
...
#define NOZZLE_PAUSE_Z_FEEDRATE                  3000  // (mm/min) Z axis feedrate

/**
 * Manual Leveling
 * Move to four corner points to Leveling manually (Point 1, Point 2, Point 3, Point 4).
 */
#define LEVELING_EDGE_DISTANCE        5  // Inset distance from bed's edge for calculating leveling point location
...
#define LEVELING_POINT_Z_FEEDRATE    3000  // (mm/min) Z axis move feedrate
...
#define Z_FADE_MAX_VALUE     320.0f
#define Z_FADE_DEFAULT_VALUE 320.0f
 ...
 *   Options: [disable: 0, enable: 1]
 */
#define HOME_BEFORE_PLR 1  // Default: 0
...
#define CUSTOM_8_LABEL "Calibration"
#define CUSTOM_8_GCODE "G33\n"
...
#define PRINT_END_GCODE "GM77\n"  // Switch to absolute positioning, reduce filament pressure b
...
#define MESH_GRID_MAX_POINTS_X 9  // (Minimum 1, Maximum 15)
#define MESH_GRID_MAX_POINTS_Y 9  // (Minimum 1, Maximum 15)
 ...
 */
#define DELTA_PROBE_TYPE 2  // Default: 0
