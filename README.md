...
<table>
  ...
  <tr>
    <td align="center">Dans le fichier config.ini définir : # UI Settings<br/>#### Status Screen<br/># Select the default home screen while in Touch Mode.<br/># Options: [disable: 0, enable: 1]<br/><b>status_screen:0</b></td>
    <td align="center">Dans le fichier config.ini définir : # UI Settings<br/>#### Status Screen<br/># Select the default home screen while in Touch Mode.<br/># Options: [disable: 0, enable: 1]<br/><b>status_screen:1</b></td>
  </tr>
</table>
